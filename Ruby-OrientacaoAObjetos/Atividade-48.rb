# Descrição: Crie uma classe Produto com atributos nome e preco. Crie também uma classe Carrinho com atributo produto. A classe carrinho deve implementar um método total e calcular quanto custa o total baseado nos produtos que foi adicionado.
